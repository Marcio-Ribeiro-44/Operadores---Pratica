...
for (let i = 1; i <= 5; i++) {
  ...
  const calcularIr = (salarioBruto, renda_percapita) => {
  ...
  const ir = calcularIr(salarioBruto, renda_percapita)
...
let abaixoDaMedia = calcularAbaixoDaMedia(salarios, media)
